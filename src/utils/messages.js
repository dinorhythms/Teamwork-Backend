const messages = {
  ...
  articleNotFlagged: 'Article cannot be deleted, its not flagged',
  ...
  commentNotFlagged: 'Comment cannot be deleted, its not flagged',
  commentdeleted: 'Comment deleted successfully',
  gifExists: 'You have an existing gif with same title, please check',
  gifNotFlagged: 'Gif post cannot be deleted, its not flagged',
